        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-8 items-center">
          ...
          <div className="space-y-8 text-center lg:text-left">
            ...
            <h1 className="text-4xl md:text-5xl xl:text-7xl font-black leading-tight animate-slide-up">
              Perlindungan Realtime Dari {/* GRADIENT UPDATED: dark:to-purple-900 */}
              <span className="text-transparent bg-clip-text bg-gradient-to-r from-purple-900 to-purple-400 dark:from-purple-400 dark:to-purple-900">Tautan Berbahaya</span>
            </h1>
            {/* Sub-headline */}
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start animate-slide-up" style={{ animationDelay: "0.2s" }}>
              ...
              {/* Tombol Testing ini sebelumnya tidak sengaja terhapus */}
            ...
            {/* <-- Tag penutup ini sebelumnya hilang */}
            {/* Stats */}
